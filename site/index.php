...
Fancy new frontend can be seen <a href="wowSuchList.php">here</a> if you really care though.<br>
If you're feeling lucky, try a <a href="getMissionZip.php?id=<?= $random ?>">random mission</a>.
